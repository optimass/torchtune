...
_ALL_RECIPES = [
    ...
    Recipe(
        ...
        configs=[
            ...
            Config(name="llama3_1_ds/8B_full_ds", file_path="llama3_1/8B_full_ds.yaml"),
            ...
            Config(name="qwen2_5/32B_full", file_path="qwen2_5/32B_full.yaml"),
        ...
        Recipe(
        name="full_finetune_distributed_priv",
        file_path="full_finetune_distributed_privilaged.py",
        configs=[
            Config(name="llama2/7B_full", file_path="llama2/7B_full.yaml"),
            Config(name="llama2/13B_full", file_path="llama2/13B_full.yaml"),
            Config(name="llama3/8B_full", file_path="llama3/8B_full.yaml"),
            Config(name="llama3_1/8B_full", file_path="llama3_1/8B_full.yaml"),
            Config(name="llama3_1/8B_full_ds", file_path="llama3_1/8B_full_ds.yaml"),
            Config(name="llama3_2/1B_full", file_path="llama3_2/1B_full.yaml"),
            Config(name="llama3_2/3B_full", file_path="llama3_2/3B_full.yaml"),
            Config(name="llama3/70B_full", file_path="llama3/70B_full.yaml"),
            Config(name="llama3_1/70B_full", file_path="llama3_1/70B_full.yaml"),
    ...
    Recipe(
        name="traj_lora_dpo_distributed",
        file_path="traj_lora_dpo_distributed.py",
        configs=[
            Config(name="llama3_2/3B_lora", file_path="llama3_2/3B_lora_dpo.yaml"),
            Config(name="llama3_1/8B_lora", file_path="llama3_1/8B_lora_dpo.yaml")
        ],
        supports_distributed=True,

    ),
    Recipe(
        name="prime_distributed",
        file_path="prime_distributed.py",
        configs=[
            Config(name="llama3_2/3B_lora", file_path="llama3_2/3B_lora_dpo.yaml"),
            Config(name="llama3_1/8B_lora_dpo", file_path="llama3_1/8B_lora_dpo.yaml")
        ],
        supports_distributed=True,
